...
class TestBWAAlignmentPipeline(unittest.TestCase):

    def test_docker_call(self):
        
        tool = ['quay.io/ucsc_cgl/exome-cgl-pipeline:1.9.1--{}'.format(tag)]
        # Provide UUID?
        args = ['--normal=/foo', 
                '--tumor=/foo', 
                '--reference=/foo', 
                ...
                '--cosmic=/foo', 
                '--output-dir=/foo']
        # Other flags? run-mutect, pindel, muse, preprocess?
